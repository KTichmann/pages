          ...
          <div className="about-section">
            ...
            <div className="about-section-wording">
              ...
              <p>
                ...
                explicabo repellat possimus? Assumenda molestiae repellendus
                eius enim facere eos vero id explicabo repellat possimus
              </p>
            </div>
          </div>
          <div className="about-section">
          ...
          <div className="row flex">
            <div className="el">
              ...
              <p>
                ...
                Repellendus ea voluptatibus at iusto reiciendis, neque velit,
                rem exercitationem.
              </p>
            </div>
            <div className="el">
